...
@export var required_flag: String = "unlock_sweet_mini_game"   
...
func _evaluate_availability() -> void:
	if QuestManager.is_flag_active(required_flag) and !PlayerManager.is_item_used("drawer"):
		interaction_area.monitoring = true
		interaction_area.monitorable = true
	elif !QuestManager.is_flag_active(required_flag):
		interaction_area.monitoring = false
		interaction_area.monitorable = false
	elif PlayerManager.is_item_used("drawer"):
		interaction_area.monitoring = false
		interaction_area.monitorable = false
	return
...
func _on_interact():
	...
	PlayerManager.add_used_item("drawer")
	_evaluate_availability()
